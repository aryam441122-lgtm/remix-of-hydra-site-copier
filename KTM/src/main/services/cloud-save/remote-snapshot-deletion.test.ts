  ...
  it("deletes unchanged automatic saves and conflicts on changed or new saves", () => {
    ...
    const plan = buildRemoteSnapshotDeletionPlan(
      context(
        ...
        [
          "C:\\Users\\KTM\\AppData\\Roaming\\Game\\unchanged.sav",
          "C:\\Users\\KTM\\AppData\\Roaming\\Game\\modified.sav",
          "C:\\Users\\KTM\\AppData\\Roaming\\Game\\added.sav",
        ]
      ),
    ...
    const plan = buildRemoteSnapshotDeletionPlan(
      context(
        ...
        [
          ...
          "C:\\Users\\KTM\\AppData\\Roaming\\Game\\automatic.sav",
        ]
      ),

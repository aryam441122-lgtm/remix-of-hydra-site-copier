...
const windowsContext = {
  ...
  homeDir: "C:/Users/KTM",
  documentsDir: "C:/Users/KTM/Documents",
  appDataDir: "C:/Users/KTM/AppData/Roaming",
  localAppDataDir: "C:/Users/KTM/AppData/Local",
};
...
describe("stored cloud save custom path bindings", () => {
  it("resolves and migrates an old portable binding", () => {
    ...
    assert.deepEqual(result.migrations, [
      {
        rawPath,
        localPath: "C:/Users/KTM/Documents/Game",
  ...
  it("marks a missing Wine profile as recoverable and resolves it later", () => {
    ...
    const unavailableContext = {
      ...
      winePrefixPath: "/home/ktm/prefix",
    };
    ...
    const recovered = resolveStoredCloudSaveCustomPathBindings([{ rawPath }], {
      ...unavailableContext,
      wineUserProfilePath: "/home/ktm/prefix/drive_c/users/steamuser",
    });
    assert.equal(
      recovered.bindings.ready[0].path,
      "/home/ktm/prefix/drive_c/users/steamuser/Documents/Game"
    );
  ...
  it("keeps legacy, foreign and malformed records visible but blocked", () => {
    const entries = [
      {
        rawPath: "<custom><windows>C:/Users/KTM/Documents/Legacy",
      },

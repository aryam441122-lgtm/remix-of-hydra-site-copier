...
const binaryNameByPlatform: Partial<Record<NodeJS.Platform, string>> = {
  darwin: "ktm-python-rpc",
  linux: "ktm-python-rpc",
  win32: "ktm-python-rpc.exe",
};
...
export class PythonRPC {
  ...
  private static resolvePythonExecutable() {
    ...
    throw new Error(
      "Python executable not found. Set KTM_PYTHON_BIN or install python3/python."
    );
  }

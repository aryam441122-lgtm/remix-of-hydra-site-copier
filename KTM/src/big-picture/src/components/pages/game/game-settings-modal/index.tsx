...
const GAME_SETTINGS_TAB_FOCUS_IDS: Record<GameSettingsTabId, string> = {
  ...
  ktm_cloud: GAME_CLOUD_V2_SETTINGS_PRIMARY_CONTROL_ID,
  ktm_cloud_legacy: GAME_CLOUD_SETTINGS_PRIMARY_CONTROL_ID,
...
export function GameSettingsModal({
  ...
  useEffect(() => {
    const isUnavailableTab =
      (activeTabId === "ktm_cloud" && !shouldShowCloudV2Tab) ||
      (activeTabId === "ktm_cloud_legacy" && !shouldShowLegacyCloudTab) ||

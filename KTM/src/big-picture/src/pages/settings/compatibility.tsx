    ...
    >
      {shouldRenderProtonSection ? (
        <SettingsSection
          ...
          description="Choose which Proton version KTM should use by default for compatible games."
        >
          <VerticalFocusGroup
      ...
      {shouldRenderBehaviorSection ? (
        <SettingsSection
          title="Behavior"
          description="Control which compatibility helpers KTM should use when launching supported games."
        >

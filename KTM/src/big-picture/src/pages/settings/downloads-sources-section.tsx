...
export function DownloadsSourcesSection({
  ...
  return (
    <>
      <SettingsSection
        title="Sources"
        description="KTM will fetch the download links from these sources. The source URL must be a direct link to a .json file containing the download the links."
        className={className}
      >
        <VerticalFocusGroup
      ...
      <ConfirmationModal
        ...
        description="This will remove every configured download source from KTM."

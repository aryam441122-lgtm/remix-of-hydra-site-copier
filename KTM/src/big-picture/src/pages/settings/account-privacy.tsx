...
import {
  ACCOUNT_PRIVACY_KTM_CLOUD_BUTTON_ID,
...
function getKTMCloudSectionContent(
...
export function AccountPrivacySettingsSection({
  ...
  const fetchBlockedUsers = useCallback(async () => {
    ...
    const response = await globalThis.window.electron.ktmApi
  ...
  const ktmCloudContent = useMemo(() => {
    return getKTMCloudSectionContent(
  ...
  const ktmCloudButtonOverrides = useMemo<FocusOverrides>(
    () => ({
        ...
        return [
          focusId,
          {
            up: previousItem
              ...
              : {
                  type: "item",
                  itemId: ACCOUNT_PRIVACY_KTM_CLOUD_BUTTON_ID,
                },
            down: nextItem
  ...
  return (
    ...
    >
      ...
      <SettingsSection
        title="KTM Cloud"
        description="Check your subscription status and manage your KTM Cloud plan."
      >
        <div className="account-privacy-settings-section__section-content">
          <div className="account-privacy-settings-section__subscription-copy">
            {ktmCloudContent.description.map((line) => (
              <p
                key={line}
          ...
          <Button
            ...
            focusId={ACCOUNT_PRIVACY_KTM_CLOUD_BUTTON_ID}
            focusNavigationOverrides={ktmCloudButtonOverrides}
            onClick={() => {
              void globalThis.window.electron.openCheckout();
            }}
          >
            {ktmCloudContent.callToAction}
          </Button>
        </div>
      </SettingsSection>

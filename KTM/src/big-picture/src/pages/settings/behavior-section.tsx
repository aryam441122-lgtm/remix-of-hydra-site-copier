    ...
    const baseItems: BehaviorItem[] = [
      {
        ...
        label: "Don't hide KTM when closing",
      ...
      },
      {
        ...
        label: "Hide KTM to tray on game startup",
        ...
        ? [
            {
              ...
              label: "Launch KTM on system start-up",
        ...
        : []),
      {
        ...
        label: "Launch KTM in the Library page",

...
export default function ComponentLab() {
  ...
  const handleErrorToast = useCallback(() => {
    presentToastDemo({
      ...
      message:
        "KTM couldn't reach the cloud right now. Try again in a few minutes.",
      imageUrl: toastImageUrl ?? undefined,
    });
  }, [presentToastDemo, toastImageUrl]);
      ...
      <div className="catalogue-page__sections">
        ...
        >
          <div className="catalogue-page__input-row">
            <Input label="Default" placeholder="KTM" />
            <Input
              label="With icons"
              placeholder="Search"
        ...
        >
          <div className="catalogue-page__filter-preview">
            ...
            >
              Showing search results for <q>ktm</q>
            </Typography>
        ...
        >
          ...
          <div className="catalogue-page__toast-notes">
            ...
            <Typography variant="label">
              Fallback: no image so the KTM icon should render.
            </Typography>
            <Typography variant="label">

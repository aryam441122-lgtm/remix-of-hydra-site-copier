...
const CLASSICS_LAUNCH_FALLBACK: ClassicsLaunchNotice = {
  title: "Launch failed",
  message: "KTM could not launch this Classics game.",
  kind: "error",
};
...
> = {
  ...
  PLATFORM_UNKNOWN: {
    ...
    message: "KTM could not identify an emulator for this platform.",
    kind: "error",
  },
  NO_DISC: {
    title: "No disc found",
  ...
  PKG_UNREADABLE: {
    ...
    message:
      "KTM could not read this package. Install and launch it from RPCS3 directly.",
    kind: "error",
  },
};
    ...
    <VerticalFocusGroup regionId={GAME_PAGE_REGION_ID} asChild>
      <div ref={pageRef} className="game-page">
        ...
        <ConfirmationModal
          ...
          description="Close the current RPCS3 session before launching this game, or force KTM to start it again."

...
export function ProfileContent() {
  ...
  const fetchUserReviews = useCallback(async () => {
    ...
    try {
      const response = await window.electron.ktmApi.get<UserReviewsResponse>(
  ...
  const handleVoteReview = async (reviewId: string, isUpvote: boolean) => {
    ...
    try {
      ...
      await window.electron.ktmApi.put(
  ...
  const content = (() => {
    ...
    const shouldLockProfile = userProfile.profileVisibility === "PRIVATE";

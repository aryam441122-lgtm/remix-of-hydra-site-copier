...
export function DownloadSettingsModal({
  ...
  const downloadOptions = useMemo(() => {
    ...
    return allDownloaders
      .filter((downloader) => {
        if (downloader === Downloader.KTM) return false; // Temporarily comment out Nimbus
        if (
      ...
      .map((downloader) => {
        ...
        // } else if (downloader === Downloader.KTM) {
              ...
              {downloadOptions.map((option, index) => {
                      ...
                      <span
                        ...
                        data-tooltip-content={
                          option.downloader === Downloader.VikingFile
                            ? t("downloader_requires_ktm_cloud")
                ...
                const getRightContent = () => {
                  ...
                  if (
                    ...
                    return (
                      <div className="download-settings-modal__recommendation-badge">
                        <span className="download-settings-modal__ktm-cloud-badge">
                          KTM Cloud
                        </span>
                      </div>
                    );

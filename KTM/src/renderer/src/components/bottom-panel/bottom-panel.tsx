...
const KTM_CLOUD_GRADIENT_START_COLOR = "#16b195";
const KTM_CLOUD_GRADIENT_END_COLOR = "#3e62c0";
            ...
            >
              <defs>
                ...
                >
                  <stop
                    offset="0%"
                    stopColor={KTM_CLOUD_GRADIENT_START_COLOR}
                  />
                  <stop
                    offset="100%"
                    stopColor={KTM_CLOUD_GRADIENT_END_COLOR}
                  />
                </linearGradient>
              </defs>
            </svg>

...
contextBridge.exposeInMainWorld("electron", {
  ...
  installKTMDeckyPlugin: () => ipcRenderer.invoke("installKTMDeckyPlugin"),
  getKTMDeckyPluginInfo: () => ipcRenderer.invoke("getKTMDeckyPluginInfo"),
  ...
  signInWithEmail: (payload: { email: string; password: string }) =>
    ipcRenderer.invoke("signInWithEmail", payload),
  signUpWithEmail: (payload: {
    email: string;
    password: string;
    username?: string;
    displayName?: string;
  }) => ipcRenderer.invoke("signUpWithEmail", payload),
  getCloudSession: () => ipcRenderer.invoke("getCloudSession"),
  onSignIn: (cb: () => void) => {
    const listener = (_event: Electron.IpcRendererEvent) => cb();

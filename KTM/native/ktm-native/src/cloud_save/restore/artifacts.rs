...
const RESTORE_ARTIFACT_PREFIX: &str = ".ktm-restore-";
const DELETE_ARTIFACT_PREFIX: &str = ".ktm-delete-";
...
mod tests {
    ...
    fn recognizes_only_exact_internal_artifact_names() {
        ...
        for name in [
            ".ktm-restore-save.dat".to_string(),
            ".ktm-restore-not-a-hash-stage".to_string(),
            format!("{RESTORE_ARTIFACT_PREFIX}{}-other", "a".repeat(64)),
            format!("{RESTORE_ARTIFACT_PREFIX}{}-stage", "A".repeat(64)),
            ".ktm-delete-not-a-uuid-backup".to_string(),
